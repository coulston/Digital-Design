...
are connected together. For example, the signal \hdl{randBut} connects the button input to the 2:1 mux in the upper left corner of  the FPGA.
...
placeholder for an integer value that describes the width of the \hdl{y1, y0, F}
 signals.  You can specify this width when you instantiate a \hdl{genericMux2x1} module using the \hdl{\#()} specifier immediately after \hdl{genericMux2x1} as shown in the bottom line of code in Listing 1. 
