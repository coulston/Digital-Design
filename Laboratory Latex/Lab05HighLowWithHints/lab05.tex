...
\begin{lstlisting}[language=Verilog,
 ...
 frame=single]
// Module definition for the addSub module 
genericAdderSubtractor(a, b, fnc, sumDiff, sovf, uovf);

// Instantiation for addSub in hotCold digital circuit
...
\begin{verbatim}
    ...
    hot = wLT;                      // given to you in  Figure 1
\end{verbatim}
...
One you have the logic for the hot/wrm nd cold signals you an start building the
hotWarmold logic block.
...
\begin{lstlisting}[language=Verilog,
 caption={The module declaration for the hotCold module if you did or did
...
module hotCold(seedSwitch, guessSwitch, hotColdBut, hotColdSeg);

// If you successfully completed previous lab, then use this module declaration (with no line break)
module hotCold (seedSwitch, playSwitch, guessSwitch, randBut, hiLowBut, hotColdBut, 
	randSeg, greenLEDs, hiLowSeg, hotColdSeg);
 \end{lstlisting}
...
and output devices used by the hotCold module.
...
\subsubsection{Module: hotCold}

\begin{itemize}
    \item
        \protect\hyperlink{hilow-module}{Link} Verilog code for the body of
        the hotCold module (courier 8-point font single spaced), leave out
        header comments.
