\section{Chapter 5 -- Sequential Circuits}
...
The {\it When} and {\it How} dimensions are arranged in the
following table.
...
{\bf Complete the timing diagram.}

\scalebox{0.5}{\includegraphics{./FigWork/BMEtime}}
