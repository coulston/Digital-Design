...
\textit{ random location} is the same.  
...
Assume the contents of the RAM are shown in Figure~\ref{fig:sequentialBBram}.
...
Consider the contents of the RAM shown in Figure~\ref{fig:sequentialBBram}.
