...
\item {\bf ($1.7*10^6$ pts.)} What does F(0,1,0) equal?
...
\item {\bf ($0.6*10^6$ pts.)} A cell in a 8 variable kmap is adjacent to how many 
other cells?  
\begin{description}
\item{a) } 3
\item{b) } 8
...
\item {\bf ($2.0*10^6$ pts.)} How many different \SOPmin solutions exist for \\
...
\pagebreak
\item {\bf ($3.2*10^6$ pts.)} Determine the \SOPmin expression for \\
