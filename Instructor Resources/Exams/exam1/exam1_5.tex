...
\underline{For questions 6-9 assume $F(A,B,C)= (A(B'+C)' + A'B)'$ }
...
\underline{For questions 10-12 use the figure below.}
\begin{figure}[ht]
...
\pagebreak
\item {\bf (2 pt.)} What is the \SOPmin expression for H(A,B,C)?
\begin{description}
\item{a) } AC' + A'BC
\item{b) } BC' + AB'C
\item{c) } BC + AB
