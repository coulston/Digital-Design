...
\begin{description}
\item{a) } Having a single output drive multiple inputs.
\item{b) } Connecting wires together.
\item{c) } Connecting a gate's output to another gate's input.
\item{d) } Connecting outputs together.
\item{e) } Connecting inputs together.
\end{description}
...
F(A,B,C,D)=$\prod$M(0,1,3,4,6,11,13,15)*$\prod$d(2,7,8,9,14)
...
\begin{description}
\item{a) }(A'+D)(A+B'+D')
\item{b) }(A'+C+D)(A+B'+D')(A'+C'+D)
\item{c) }(A+B'+D')(A'+D')(B+D')(A+B+C)
\item{d) }(A+B'+C+D)(A'+B+C'+D)(A+B'+C+D')
\item{e) } None of the above.
\end{description}
