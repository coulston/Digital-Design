...
$$\begin{array}{cll}
$$\begin{array}{c||c|c|c|c}
        x \bs Q_1 Q_0 & 00  & 01  & 11  & 10  \\ \hline \hline
        0             & 11  & 11  & 01  & 01 \\ \hline
        1             & 10  & 00  & 00  & 10 \\
\end{array}$$
&
...
Q1^+ Q0^+ & Q1= & Q0= \\
\end{array}$$}
\item {\bf (2 pts.)} What does $D1=$ ?
\begin{description}
\item{a) }$Q_1'Q_0' + X'Q_1' + XQ_1Q_0'$
\item{b) }$Q_1'Q_0' + X'Q_1' + XQ_0'$
\item{c) }$X'Q_1' + XQ_1Q_0'$
\item{d) }$X'Q_1' + XQ_0'$
\item{e) }$X'$
\end{description}

\item {\bf (2 pts.)} What does $D0=$ ?
\begin{description}
\item{a) }$Q_1'Q_0' + X'Q_1' + XQ_1Q_0'$
\item{b) }$Q_1'Q_0' + X'Q_1' + XQ_0'$
\item{c) }$X'Q_1' + XQ_1Q_0'$
