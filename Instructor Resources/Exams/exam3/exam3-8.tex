...
F(A,B,C,D)=$\Sigma$m(3,4,5,6,7,8,9,11,12)
...
\pagebreak
For questions 14-19 use the state diagram below.  Assume that the
...
Consult it for questions 23-25.  Note, this question
...
Questions 27-30 concern themselves with the problem of 
...
\pagebreak
Questions 35-59 {\bf (1 pt. each)} This question deals with the construction 
...
\pagebreak
Questions 60-63 are based on the datapath and control shown on the previous page.
...
\pagebreak
For problems 64-68 use the following figure and timing diagram.
