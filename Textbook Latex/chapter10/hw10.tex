...
\begin{figure}[ht]
\center{\includegraphics{Prob4-16}}
\end{figure}
} \end{onlysolution} 
                                                                                
\item\textbf{ (3 pts.)} Build a 2:1 mux using some tristate buffers and an inverter.                                                                                
\item\textbf{ (3 pts.)} Build a 4:1 mux using some tristate buffers and two inverters.
                                                                                
\begin{onlysolution} \textbf{Solutions} \itshape {
\begin{figure}[ht]
\center{\includegraphics{Prob4-17}}
\end{figure}
} \end{onlysolution} 
...
\begin{figure}[ht]
\center{\includegraphics{Prob10-4}}
...
\begin{figure}[ht]
\center{\includegraphics{Prob10-4b}}
...
\begin{figure}[ht]
\center{\includegraphics{Prob10-6}}
...
\begin{figure}[ht]
\center{ \scalebox{0.75}{\includegraphics{Prob10-6b}} }
...
Others:        & none					\\ \hline
Behavior:      & \scalebox{0.75}{\includegraphics{Prob10-6c}}	\\ \hline
\end{tabular}
