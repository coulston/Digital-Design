...
\begin{enumerate}
    ...
    \item \textbf{ (12 pts.)}
        ...
        \ifshowanswers \includegraphics[max width=0.8\textwidth, center]{Sol7-6}
        \else      \includegraphics[max width=0.8\textwidth, center]{Prob7-6} \fi
    ...
    \item \textbf{ (12 pts.)}
        ...
        \begin{figure}[ht]
            \center{\includegraphics{Prob7-7}}
