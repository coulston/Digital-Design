...
\begin{enumerate}
    ...
    \item \textbf{ (36 pts.)}
        ...
        \begin{onlysolution}[fragile] \color{blue}%required to use verbatim environments inside of an answer
            % Let me know what syntax I should use when waiting for the alignment. Currently it is the syntax I learned from embedded.
\begin{lstlisting}
int loc;
int delta;
while(1) {
    ...
    if delta != 0 {
        ...
        while delta > 0{
            while (Align == 1); // Wait to stop being aligned
            delta--;
            while (Align == 0); // Wait until aligned
        }
        Motor[1] = 0;
        Motor[0] = 0;
        Door = 1;
