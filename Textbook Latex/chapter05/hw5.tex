...
\begin{enumerate}
    ...
    \item \textbf{ (8 pts.)} Complete the timing diagram for the circuit
        ...
        \begin{figure}[ht]
            ...
            \center{\scalebox{0.8}{\includegraphics{Prob5-3}}}
    ...
    \item \textbf{ (15 pts.)} Complete the timing diagram for the basic memory
        ...
        \begin{figure}[ht]
            \center{\scalebox{0.5}{\includegraphics{Prob5-4}}}
        ...
        \begin{onlysolution}  \textbf{Solution} \itshape{
                \begin{figure}[ht]
                    \center{\scalebox{0.5}{\includegraphics{Sol5-4}}}
                \end{figure}
            }
        \end{onlysolution}
    ...
    \item \textbf{ (15 pts.)} Complete the timing diagram for the basic memory elements in
        ...
        \begin{figure}[ht]
            \center{\scalebox{0.5}{\includegraphics{Prob5-5}}}
            \caption{}
        ...
        \begin{onlysolution}  \textbf{Solution} \itshape{
                \begin{figure}[ht]
                    \center{\scalebox{0.5}{\includegraphics{Sol5-5}}}
                \end{figure}
            }
        \end{onlysolution}
