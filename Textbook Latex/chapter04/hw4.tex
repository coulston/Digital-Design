        ...
        \item \textbf{ (10 pts.)}Build a BCD to 7-Segment Display converter using
            ...
            \begin{enumerate}
                \item Use Espresso to determine the \SOPmin expression for the outputs
                    ...
                    \begin{onlysolution} \textbf{Solutions} \itshape{
                            The following is the source file for the BCD to 7-segment {converter. \color{blue}\lstinputlisting{./chapter04/FigHw/sol4-5-a.txt}}

                            The following is the output from espresso on the
                            BCD to 7-segment converter. {\color{blue}\lstinputlisting{./chapter04/FigHw/sol4-5-a.sol}}
                        }
                    \end{onlysolution}
...
%% \end{verbatim}
        ...
        \item \textbf{ (10 pts.)}
            ...
            \begin{onlysolution} \textbf{Solution:}
                \textit{\color{blue} As this is a Ones-Hot system, we need to build each gate separate. Here are the equations for each output, and a consolidated logic diagram.}
                \begin{align*}
                    IsP =&\ d7'\, d6 \, d5'\, d4'\, d3 \, d2 \, d1'\, d0;  \\
                    IsL =&\ d7'\, d6 \, d5'\, d4'\, d3 \, d2'\, d1 \, d0;  \\
                    IsM =&\ d7'\, d6'\, d5 \, d4 \, d3 \, d2'\, d1 \, d0'; \\
                    IsI =&\ d7'\, d6 \, d5'\, d4'\, d3'\, d2'\, d1 \, d0;  \\
                    IsS =&\ d7'\, d6'\, d5'\, d4 \, d3 \, d2'\, d1 \, d0;
                \end{align*}
                \includegraphics[scale=0.25]{Sol4-15.png} % Generated with Logic Friday
            \end{onlysolution}
        \item \textbf{ (10 pts.)}
            ...
            \begin{onlysolution}
                {\color{blue}
                    \begin{align*}
                        Is1 =&\ d7'\, d6'\, d5'\, d4 \, d3'\, d2 \, d1 \, d0'; \\
                        Is2 =&\ d7'\, d6'\, d5'\, d4 \, d3 \, d2 \, d1 \, d0'; \\
                        Is3 =&\ d7'\, d6'\, d5 \, d4'\, d3'\, d2 \, d1 \, d0'; \\
                        Is4 =&\ d7'\, d6'\, d5 \, d4'\, d3'\, d2 \, d1'\, d0; \\
                        Is5 =&\ d7'\, d6'\, d5 \, d4'\, d3 \, d2 \, d1 \, d0'; \\
                        Is6 =&\ d7'\, d6'\, d5 \, d4 \, d3'\, d2 \, d1 \, d0'; \\
                        Is7 =&\ d7'\, d6'\, d5 \, d4 \, d3 \, d2 \, d1'\, d0; \\
                        Is8 =&\ d7'\, d6'\, d5 \, d4 \, d3 \, d2 \, d1 \, d0'; \\
                        Is9 =&\ d7'\, d6 \, d5'\, d4'\, d3'\, d2 \, d1 \, d0'; \\
                        Is0 =&\ d7'\, d6 \, d5'\, d4'\, d3'\, d2 \, d1'\, d0; \\
                        IsA =&\ d7'\, d6'\, d5'\, d4 \, d3 \, d2 \, d1'\, d0'; \\
                        IsB =&\ d7'\, d6'\, d5 \, d4 \, d3'\, d2'\, d1 \, d0'; \\
                        IsC =&\ d7'\, d6'\, d5 \, d4'\, d3'\, d2'\, d1'\, d0; \\
                        IsD =&\ d7'\, d6'\, d5 \, d4'\, d3'\, d2'\, d1 \, d0; \\
                        IsE =&\ d7'\, d6'\, d5 \, d4'\, d3'\, d2 \, d1'\, d0'; \\
                        IsF =&\ d7'\, d6'\, d5 \, d4'\, d3 \, d2'\, d1 \, d0;
                \end{align*}}
                \newpage
                \includegraphics[scale=0.25]{Sol4-16.png} % Generated with Logic Friday
            \end{onlysolution}
    \end{enumerate}
