...
\begin{enumerate}
    \item \textbf{(2 pts. each)}Short answer:
        ...
        \item \textbf{ (2 pts.)}Show how to connect together four 4-bit comparators to
            ...
            \begin{onlysolution} \filbreak\textbf{Solutions}\\ \itshape{\includegraphics[max width = 0.95\textwidth]{Sol4-3} With L1, G1, E1 as the outputs from the highest four bits, and G4, E4, L4 as the output from the low bits.
