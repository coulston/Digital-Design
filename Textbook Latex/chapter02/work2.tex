...
\begin{tabular}[ht]{cl|l}
    & Regular Algebra         & Boolean Algebra \\ \cline{2-3}
    Performed First                     & Parenthesis             & Parenthesis     \\ \cline{2-3}
    \multirow{2}{*}{$\bigg\Downarrow$}  & Exponents               & Not             \\ \cline{2-3}
    & Multiplication/Division & And             \\ \cline{2-3}
    Performed Last                      & Addition/Subtraction    & Or
\end{tabular}

\vspace{0.2in}
\begin{tabular}[ht]{lc>{\quad}c} % give extra space for row 8 ergonomically
