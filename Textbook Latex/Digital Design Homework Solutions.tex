...
\raggedbottom % Tell LaTeX that we are fine with pages not being full. This means it will not try to stretch content to fit the page, which looks bad since the contents are mostly figures.
\chapterstyle{ger}
\settrims{0pt}{0pt}
