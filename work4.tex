\section{Chapter 4 -- Combinational Logic Building Blocks}
...
\scalebox{0.5}{\includegraphics{./FigWork/OddDecoder}}

{\bf Label the inputs of the mux.}

\scalebox{0.5}{\includegraphics{./FigWork/OddMux}}
